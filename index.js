...
(async () => {
    ...
    //LOGIN
    await page.type('input[name="session[r-30o5oe r-1niwhzg r-17gur6a r-1yadl64 r-deolkf r-homxoj r-poiln3 r-7cikom r-1ny4l3l r-t60dpp r-1dz5y72 r-fdjqy7 r-13qz1uu]"]',username,{delay: 10});
		await page.type('input[name="session[password]"]',password,{delay: 10});
    await page.click('div[data-testid="LoginForm_Login_Button"]');

    //SEARCH TERM
    await page.waitFor('input[data-testid="SearchBox_Search_Input"]');
    await page.type('input[data-testid="SearchBox_Search_Input"]', '#freeCodeCamp', {delay:25});
